...
int main(int argc, char **argv)
{
 ...
 if (MyRank==Root)
    {
     //Do de Scatterv
     MPI_Scatterv(pVector1,pSizeSubV, pPosSubV, MPI_INT, MPI_IN_PLACE,
                  0,MPI_INT, Root, MPI_COMM_WORLD);
     MPI_Scatterv(pVector2,pSizeSubV, pPosSubV, MPI_INT, MPI_IN_PLACE, 
                  0,MPI_INT, Root, MPI_COMM_WORLD);
    }
 ...
 if (MyRank!=Root)
    {
     ...
     //Do de Scatterv
     MPI_Scatterv(pVector1,pSizeSubV, pPosSubV, MPI_INT, pSubVector1,
                  pSizeSubV[MyRank],MPI_INT, Root, MPI_COMM_WORLD);
     MPI_Scatterv(pVector2,pSizeSubV, pPosSubV, MPI_INT, pSubVector2, 
                  pSizeSubV[MyRank],MPI_INT, Root, MPI_COMM_WORLD);
