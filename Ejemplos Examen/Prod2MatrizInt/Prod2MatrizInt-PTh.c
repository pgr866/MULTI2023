...
void * Prod2MatrizInt(void * pTh_Args)
//int ** pMatriz1, int ** pMatriz2, int ** pMatriz3, const int Rows, const int Cols
{
 Type_Th_Args * pMyData;
 pMyData=(Type_Th_Args *) pTh_Args;
  ...
  for (int t=0; t<NThreads; t++) 
     {
      ...
      pthread_create(&pThreads[t],NULL,Prod2MatrizInt, (void *)&pTh_Args[t]);
     }
