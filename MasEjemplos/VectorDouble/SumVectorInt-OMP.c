...
/*---------------------------------------------------------------------------*/
void SumVectorDouble(double *pVector1, double *pVector2, double *pVector3, const double Rows)
{
...
int main(int argc, char **argv)
{
 ...
 //Calloc de Getmen put data to zeroes
  pVector1  = (double *) GetMem(Rows,sizeof(double),"Main:Vector");
  pVector2  = (double *) GetMem(Rows,sizeof(double),"Main:Vector");
  pVector3  = (double *) GetMem(Rows,sizeof(double),"Main:Vector");
 
 #if (DEBUG==1)
 gettimeofday(&tv1, &tz);
 #endif
 
 InitVectorDouble(pVector1,Rows);
 InitVectorDouble(pVector2,Rows);
 ...
 #if (PRINT==1)
 PrintVDouble(stdout,pVector1,Rows);
 PrintVDouble(stdout,pVector2,Rows);
 printf("\n");
 #endif
 ...
 SumVectorDouble(pVector1,pVector2,pVector3,Rows);
 ...
 TInitV+TMinV);
  ...
  #if (PRINT==1)
 PrintVDouble(stdout,pVector3,Rows);
 #endif
